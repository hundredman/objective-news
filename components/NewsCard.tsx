      ...
      <div className="p-6">
        ...
        <div className="space-y-3 mb-5">
          <button
            ...
            className="w-full flex items-center justify-between gap-2 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
          >
            ...
            <svg
              className={`w-4 h-4 transition-transform ${factsExpanded ? 'rotate-180' : ''}`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
